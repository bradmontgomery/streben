...
from app.services.zones import get_zone_settings, zone_bounds
...
def activity_detail(request: Request, activity_id: int):
    ...
    zone_settings = get_zone_settings()
    power_zone_html = build_zone_chart(streams, "watts", zone_bounds(zone_settings, "power"), "Power (W)")
    hr_zone_html = build_zone_chart(streams, "heartrate", zone_bounds(zone_settings, "hr"), "Heart Rate (bpm)")
